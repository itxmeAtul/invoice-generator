...
export default function Page() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-4">
      <div className="w-full max-w-4xl p-4  bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 dark:text-black md:mt-10 dark:text-black">
        <div className="relative z-0 w-full mb-6 group flex justify-between">
          <div className="relative  overflow-hidden font-bold text-xl text-gray-900 ">
            {showModal.visible ? "Add User" : "User Management"}
          </div>
          {!showModal.visible && (
            <div className="relative  overflow-hidden font-bold text-xl ">
              <a
                onClick={() => {
                  setShowModal({ userData: {}, visible: true });
                }}
